...
gombNovel.addEventListener(
  "mouseenter",
  (esemeny) => (novelIdozito = setInterval(novel, 10))
);
gombNovel.addEventListener("mouseleave", (esemeny) =>
  clearInterval(novelIdozito)
);
gombCsokkent.addEventListener(
  "mouseenter",
  (esemeny) => (csokkenIdozito = setInterval(csokkent, 10))
);
gombCsokkent.addEventListener("mouseleave", (esemeny) =>
  clearInterval(csokkenIdozito)
);
